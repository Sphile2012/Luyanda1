        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4">
              <li>Submit a form to request car matching services</li>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4">
              ...
              <li>ID number (for employment applications)</li>
              <li>Employment status and income information</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4">
              ...
              <li>To communicate with you about your requests and applications</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4">
              <li>Only collect personal information with your knowledge and consent</li>
              <li>Collect information for identified purposes only</li>
              <li>Ensure your information is accurate and up to date</li>
              <li>Protect your information against unauthorized access</li>
              <li>Allow you to request and access your personal information</li>
              <li>Respect your right to object to processing</li>
              <li>Retain information only as long as necessary</li>
            </ul>
            <p className="text-gray-600 leading-relaxed mt-4">
              You have the right to request access to your personal information, request
              correction of inaccuracies, and withdraw consent to further processing.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed mt-4">
              ...
              All our service providers are contractually obligated to keep your information
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              destruction. We use encryption, secure servers, and regular security audits.
